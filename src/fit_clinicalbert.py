...
if __name__ == '__main__':
    ...
    final_model_filename = f'{args.base_dir}/models/metamap-final-bydrug-{network_code}_{filename_params}.pth'
    ...
    best_epoch_model_filename = f'{args.base_dir}/models/metamap-bestepoch-bydrug-{network_code}_{filename_params}.pth'
    ...
    lafh = open(f'{args.base_dir}/results/metamap-epoch-results-{network_code}_{filename_params}.csv', 'w')
