...
def main():
    ...
    outfn = f'./data/test_ref{args.method}_nwords{args.nwords}_clinical_bert_reference_set_{args.section}_TAC.txt' # we add a "TAC" at the end to differentiate this from the previous runs
    outfh = open(outfn, 'w')
    ...
    for section in sections:
        ...
        # derive a drug list from the test data
